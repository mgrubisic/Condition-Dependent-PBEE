...
These studies did not considered the generation of the protective film due to the alkaline environment of the concrete, additionally the accelerated corrosion process used a 3% NaCl concentration solution while the chloride attack in concrete usually has a 0.4% concentration of the same Chloride. Therefore the results obtaiined from these studies might not accurately represent the actual conditions of corroded RC columns, thus an experimental campaign is proposed that would shed a light into the properties of corroded reinforcing steel inside concrete and is discussed in the following subsection.
